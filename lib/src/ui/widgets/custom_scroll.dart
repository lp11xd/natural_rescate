...
class CustomScrollNavigation extends StatefulWidget {
  ...
  @override
  CustomScrollNavigationState createState() => CustomScrollNavigationState();
}

class CustomScrollNavigationState extends State<CustomScrollNavigation> {
